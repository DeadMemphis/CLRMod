...
public class COLOSSAL_TITAN : MONO
{
    ...
    private void Start()
    {
        ...
        if (base.photonView.isMine)
        {
            ...
            {
                this.maxHealth = this.NapeArmor = UnityEngine.Random.Range(GameSettings.healthLower, GameSettings.healthUpper);
            }
            if (this.NapeArmor > 0)
            {
    ...
    public void titanGetHit(int viewID, int speed)
    {
        ...
        if (view != null)
        {
            ...
            {
                if (speed >= GameSettings.damageMode)
                {
                ...
                else
                {
                    ...
                    FengGameManagerMKII.PView.RPC("netShowDamage", view.owner, parameters);
                }
