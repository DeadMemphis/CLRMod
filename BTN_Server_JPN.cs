...
public class BTN_Server_JPN : MonoBehaviour
{
    private void OnClick()
    {
        ...
        if (PhotonNetwork.networkingPeer.UsedProtocol == ExitGames.Client.Photon.ConnectionProtocol.Udp)
            ...
            PhotonNetwork.ConnectToMaster("app-jp.exitgamescloud.com", 9090, FengGameManagerMKII.applicationId, UIMainReferences.version);
        else if (PhotonNetwork.networkingPeer.UsedProtocol == ExitGames.Client.Photon.ConnectionProtocol.Tcp)
            PhotonNetwork.ConnectToMaster("app-jp.exitgamescloud.com", 4530, FengGameManagerMKII.applicationId, UIMainReferences.version);
