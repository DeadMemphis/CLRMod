...
internal static class CustomTypes
{
    private static object DeserializePhotonPlayer(byte[] bytes)
    {
        ...
        if (NetworkingPeer.mActors.ContainsKey(num2))
        {
            return NetworkingPeer.mActors[num2];
        }
        return null;
    }
    public static object DeserializeHero(byte[] bytes)
    {
        return null;
    }
    ...
    internal static void Register()
    {
        ...
        PhotonPeer.RegisterType(typeof(FengGameManagerMKII), 66, new SerializeMethod(CustomTypes.SerializeHero), new DeserializeMethod(CustomTypes.DeserializeHero));
    }
    ...
    public static byte[] SerializeHero(object customobject)
    {
        int iD = FengGameManagerMKII.instance.photonView.viewID;
        byte[] target = new byte[4];
        int targetOffset = 0;
        Protocol.Serialize(iD, target, ref targetOffset);
        return target;
